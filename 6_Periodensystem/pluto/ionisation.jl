...
begin
		Eion = [e.ionenergy[1] for e in chem_elements[1:90]]
...
let
	...
	font = "\\footnotesize",
	 ...
	 p = @pgf PGFPlotsX.Plot(
       ...
       Table(["x" => (1:length(Eion)), "y" =>  Eion .|> ustrip ])
    )
	push!(myaxis, p)
	...
	pgfsave("../E_ionisation.tikz.tex",myaxis; include_preamble= false)
	myaxis
...
manifest_format = "2.0"
project_hash = "42452ae53935ea03fea35619c801f76bab849651"
