...
\begin{tikzpicture} 
  ...
  \begin{axis}
    [font=\footnotesize,
      ...
      \draw[thin, black] (1,0.45) -- node[xshift=-2mm] {1s} (6.2,0); % 1s

      \draw[thin, black] (1,0.69) -- node[xshift=-2mm] {2s} (15.2,0); % 2s
      \draw[thin, gray] (1,0.69) .. controls (3,0.7) and (7, 0.5)  ..  (17.6,0); % 2p

      \draw[thin, black] (1,0.83) .. controls (15,0.54) .. node[xshift=-3mm] {3s} (31.8,0); % 3s
      \draw[thin, gray] (1,0.83) .. controls (3, 0.85) and (15,0.65) .. (33.8,0); % 3p
     ...
     % \coordinate (Ca) at (20,0.57) ;
      ...
      \draw[thin, black] (1,0.92) [rounded corners]  .. controls (10, 0.8) and (12, 0.81) .. 
                   node[yshift=-1mm] {4s} (21, 0.54)   -- 
                      (30,0.52) --  (35.5,0.43); % 4s


      \draw[thin, gray] (1,0.92)  .. controls (7, 0.9)  .. (35.5,0.47); % 4p
