\renewcommand{\lastmod}{27. Oktober 2024}
...
% V[x_] := Piecewise[{{0, x < 0}, {21, 0 < x <= 4}, {0, x > 4}}]. 
% schr = -1/2 D[[Psi][x], x, x] == (Ee - V[x]) [Psi][x]; 
%  bdrs = {[Psi][xmin] == 1, [Psi]'[xmin] == -I k}; 
% psol = NDSolve[{schr, bdrs}, [Psi][x], {x, xmin, xmax}, MaxStepSize -> 0.0001]; 
