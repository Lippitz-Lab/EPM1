...
Damit wissen wir für das Teilchen im Kasten, dass die möglichen diskreten Werte der Energie durch Gl.  \ref{eq:4_En_Box}. Es gibt eine minimale Energie 
\begin{equation}
E_1 = \frac{\pi^2 \, \hbar^2}{2 m L^2}
\end{equation}
und alle anderen steigen quadratisch in $n$ an. Die Wellenfunktion ist eine stehende Welle, gegeben durch Gl. \ref{eq:4_psi_box}. Die Zahl $n$ beschreibt die Anzahl der Bäuche. An den Wänden der Box befinden sich immer Knoten.
