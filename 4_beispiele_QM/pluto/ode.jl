...
begin
	# Boundary conditions
	u0 = [1.0, exp(1im .* pi .* 0.01)]  # [Psi(xmin), Psi'(xmin)]
	
	# Set up the problem
	prob = ODEProblem(schr!, u0, (-20, 20))
	
	# Solve the problem with specified max step size
	sol = solve(prob, Tsit5())
end

# ╔═╡ 763dae7c-3d3f-4f76-acac-6a9c2bc24303
exp(1im .* pi/2)

# ╔═╡ e2e9fcd3-0ac4-4040-822c-7346814c5395
plot(sol.t, abs.([ x[1] for x in sol.u]))

# ╔═╡ d61b2f3d-0235-4e6c-8e89-d3ed7e575a12
[ x[1] for x in sol.u]
...
manifest_format = "2.0"
project_hash = "12da8885570c1b35201a4800bc4ba6bd789d2daf"
