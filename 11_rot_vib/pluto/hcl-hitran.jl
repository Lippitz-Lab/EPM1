...
fetch!("HCl_experiment", iso_id("HCl"), 1, 300, [:standard, :ht_self]);
...
wavenumbers, absorption_coefficient = α(["HCl_experiment"] );

# ╔═╡ 8e61bc47-df6d-4776-9388-fa1c71887bfd
md"""
Transmission durch 1 cm HCl Gas bei Standard-Bedigungen berechnen
"""

# ╔═╡ 483e6481-affc-429e-bdfa-85d5d1c819d3
transmittance = transmittance_spectrum(absorption_coefficient, 0.01);
...
# ╔═╡ 02a79670-50c0-4a2f-8a0f-8b908c7b3f92
plot(
    wavenumbers,
    absorption_coefficient,
    xlabel="Wavenumbers (1/cm)", 
    ylabel="Absorptionskoeffizient", 
    legend=false
)
...
manifest_format = "2.0"
project_hash = "d58d00d1b73e072db50ae2bdaa10b10561683715"
...
git-tree-sha1 = "d04488736e287298d84084fce5bd119463695f13"
