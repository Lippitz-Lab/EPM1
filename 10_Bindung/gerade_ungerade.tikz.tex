...
\tikzmath{ \x1 = 3.6; \x2 = 1.2; \x3 = 2.4; \gups=0.5;}
\tikzmath{ \dy1 = 0.5; \dy2 = 0.9;}

\tikzmath{ \xc = (\x2 + \x3)/2;}
\tikzmath{ \y = 0;}
\node at (\x1,\y) {2s$\sigma_g$};
\orbital[pos = {(\x2,\y)},scale=\gups]{s}
\orbital[pos = {(\x3,\y)},scale=\gups]{s}
\draw  (\xc,\y) circle (0.3pt);

\tikzmath{ \y = \y + \dy1;}
\node at (\x1,\y) {2s$\sigma_u^\star$};
\orbital[pos = {(\x2,\y)},scale=\gups]{s}
\orbital[pos = {(\x3,\y)}, color=black!30,scale=\gups]{s}
\draw  (\xc,\y) circle (0.3pt);

\tikzmath{ \y = \y + \dy1;}
\node at (\x1,\y) {2p$\sigma_g$};
\orbital[pos = {(\x2,\y)},scale=\gups]{py}
\orbital[pos = {(\x3,\y)},scale=\gups]{-py}
\draw  (\xc,\y) circle (0.3pt);


\tikzmath{ \y = \y + (\dy2 + \dy1)/2;}
\node at (\x1,\y) {2p$\pi_u$};
\orbital[pos = {(\x2,\y)},scale=\gups]{pz}
\orbital[pos = {(\x3,\y)},scale=\gups]{pz}
\draw  (\xc,\y) circle (0.3pt);
