...
%\useasboundingbox (-1.3,-1.2) rectangle (11.2,4.7);
 %	\draw (-1.5,-2.5) rectangle (3.5,7.5);
   \tikzmath{\x1 = 0;  \dx1 = 3;  \dx2 = 2.5; \wv = 2;  \brot = 0.05;  \ylu = -1.7; \ylo = -1; \arrowoffs = 0.12; \ytop = 5;}
  % \tikzmath{  \bs = 0.8; }
 ...
 % Zustände
  ...
  % Übergangs-Pfeile
   \foreach \a in {2,...,3}
   {
    	...
    	\draw[->] (\xa1,\brxx1) -- node (P\a) {}  (\xa1,\ytop) ;
    	\draw[->] (\xa2,\ytop) -- node (P\a) {}  (\xa2,\brxx2) ;
  }
