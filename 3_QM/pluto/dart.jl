...
# ╔═╡ 7b79fa1c-8712-11ef-2067-eb559cbcbe67
...
let
	...
	"axis equal"
		...
		push!(myaxis, p)
			...
			@pgf    p = PGFPlotsX.Plot(
        {
         only_marks, black,  mark_size="1pt",
        },
        Table([x[idr3], y[idr3] ])
    )
		push!(myaxis, p)
	...
	pgfsave("../dart.tikz.tex",myaxis; include_preamble= false)
	myaxis
...
manifest_format = "2.0"
project_hash = "66b7cf4137833a02d2072f7789a34aef4fa6acef"
