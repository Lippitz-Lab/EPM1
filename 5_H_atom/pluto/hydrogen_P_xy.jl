...
# ╔═╡ d0e476c8-dd17-4578-b6fc-9f2c281bd0ad
using Images
...
# ╔═╡ 79576aae-2b79-4805-98b9-7d1fdeb9d491
function make_png(qn, scalefac)
	
		dx = 3 .* (qn.n^2)  # r scaled by 1/n^2
		x = (-1:0.01:1);
		X = (x * ones(size(x))' ) .* dx
	 	Y = (ones(size(x)) * x' ) .* dx
		...
		filename = "P_$(qn.n)_$(qn.l)_$(qn.m).png"
...
manifest_format = "2.0"
project_hash = "f62b97a67e45c5d5f574ca88af0baefae449edbd"
