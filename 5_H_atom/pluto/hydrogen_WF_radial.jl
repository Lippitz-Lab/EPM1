...
# ╔═╡ fe9499eb-a49c-4b90-9ebe-6ce810356289
using PGFPlotsX
...
function psi(r, θ, ϕ, qn)
	...
	return radial(r; qn = qn) * Yml * phasefac #* norm
end;
...
# ╔═╡ 78664e55-c76e-4617-b5f3-9c6792aca14c
P(r ; qn) = 4 * π * r^2 * abs(radial(r; qn))^2

# ╔═╡ 35c9ea23-da51-495d-9367-8f3c5883046b
let
	r = (0:0.1:15)
	plot(r, P.(r; qn = (n = 2, m= 0, l=1)))
	plot!(r, P.(r; qn = (n = 2, m= 0, l=0)))
	
end

# ╔═╡ 746a7509-d284-48b7-989c-41a19f58dd56
let
	r = (0:0.1:20)
	...
	pgfsave("../radial_P.tikz.tex",gp; include_preamble= false)
	gp
end
