...
\newtcolorbox{zusammen}{%
 ...
 % borderline west={1pt}{0pt}{black},
  ...
  \newcommand{\phet}[1]{%
  \sidenote{\href{http://phet.colorado.edu/simulations/sims.php?sim=#1}{siehe '\detokenize{#1}'}}
  }
...
\include{7_Magnetfeld/7_Magnetfeld}
\include{8_Licht/8_Licht}


\include{10_Bindung/10_Bindung}
\include{11_Anregung/11_Anregung}
